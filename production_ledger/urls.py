...
urlpatterns = [
    ...
    path('request-access/success/', views.RequestAccessSuccessView.as_view(), name='request_access_success'),
    ...
    path('users/invitations/<uuid:pk>/', views.InvitationActionView.as_view(), name='invitation_detail'),
